...
namespace EtosErpConnectorTesting\Etos\Unit\Csv;

use EtosErpConnector\Etos\Reader\CsvReader;

class CsvReaderTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers \EtosErpConnector\Etos\Reader\CsvReader::readFromFile()
     */
    public function testReadCsv()
    {
        $reader = new CsvReader();
        $csvData = $reader->readFromFile(__DIR__ . '/../../fixtures/shopexport_short.csv');
        $firstRow = $csvData[0];
        ...
        static::assertArrayHasKey('Fussbett', $firstRow);
