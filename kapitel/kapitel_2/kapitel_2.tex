...
sollte man die entsprechenden Testprozesse dem Vorgehensmodell zuordnen. Aus diesem Grund soll hier als erstes der bisherige Entwicklungsprozess der \nomenclature{ERP}{Enterprise-Resource-Planning} Shopware ERP-Schnittstelle Etos des vorherigen Agentur-Dienstleisters vorgestellt werden. Diese Schnittstelle greift auf die \dq{}Import- und Exportschnittstelle Internetshop\dq{} der Warenwirtschaft Apollon zu. 
...
\subsubsection{Schlechte Ressourcennutzung}%NL: Kapitelangabe ist korrupt
...
Außerdem werden Integrationstests sehr viel seltener ausgeführt als eigentlich empfehlenswert. Somit steigt das Risiko, dass Fehler erst ziemlich spät auftauchen, enorm.  
...
\begin{itemize}	
	...
	%NL: zitiere dich hier mal selbst :D
	...
	%"Automated Testing"ich würde hier bei einer gleichen schreibweise bleiben
...
\begin{enumerate}
	...
	\item \textbf{Selbsttestender Build} \newline%NL: hier bitte Kapitel einfügen
